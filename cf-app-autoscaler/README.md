cf-app-autoscaler deployments
==============================

This repository contains the YAML templates that make up a series of
cf-app-autoscaler BOSH deployments, using the format prescribed by the
[Genesis][1] utility. These deployments are based off of the
[cf-app-autoscaler-genesis-kit][2].
...
To create a new environment (called `us-east-prod-cf-app-autoscaler`):
...
To download a new version of the kit, and deploy it:
    ...
    genesis download cf-app-autoscaler [version] # omitting version downloads the latest
...
- [cf-app-autoscaler-genesis-kit][2] - Details on the kit used in this repo,
...
[2]: https://github.com/genesis-community/cf-app-autoscaler-genesis-kit
