...
jumpbox BOSH deployments, using the format prescribed by the
[Genesis][1] utility. These deployments are based off of the
[jumpbox-genesis-kit][2].
...
To create a new environment (called `us-east-prod-jumpbox`):
...
To download a new version of the kit, and deploy it:
    ...
    genesis download jumpbox [version] # omitting version downloads the latest
...
- [jumpbox-genesis-kit][2] - Details on the kit used in this repo,
...
[2]: https://github.com/genesis-community/jumpbox-genesis-kit
